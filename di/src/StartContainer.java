...
//		ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("configuration.xml");
		...
		Product p1 = ctx.getBean("product", com.my.vo.Product.class); // 2번째 인자로 Down Casting 가능여부를 확인할 수 있다.
//		ctx.getBean("p", com.my.vo.Customer.class);
		Product p2 = ctx.getBean("product", com.my.vo.Product.class); // 스프링 컨테이너에 의해 관리되는 Bean은 싱들톤으로 관리된다.
