...
<head>
    ...
    <link rel="stylesheet" href="/mvc/static/css/reset.css">
    <link rel="stylesheet" href="/mvc/static/css/main.css">
    <!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css"> -->
    <link rel="stylesheet" href="/mvc/static/css/bootstrap-4.5.0-dist/css/bootstrap.min.css">
    <style>
    ...
    <script>
        $(function () {
            ...
            $signupMenu.click(() => {
                location.href = '/mvc/jq/signup.html';
            });
            //----------상품목록 메뉴 START----------
                ...
                $.ajax({
                    ...
                    , success: data => {
                        ...
                        responseArrObj.forEach((element, index) => {
                            ...
                            //cartList +=  '<img src="/mvc/images/'+element['prod_no']+'.jpg>';
                            sectionData += '<li><img src="/mvc/images/' + prod_no + '.jpg"></li>';
...
<body>
    <div class="container divContent">
        ...
        <nav>
            <%-- <jsp:include page="/mvc/fragment/menu.jsp"></jsp:include> --%>
